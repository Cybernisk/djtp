...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_usersid', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_sid_set', to=orm['accounts.User'])),
            ('sid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=512)),
            ('expired_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 8, 2, 0, 0))),
        ...
        db.send_create_signal(u'accounts', ['UserSID'])


    def backwards(self, orm):
        # Deleting model 'UserSID'
        db.delete_table(u'accounts_usersid')
    ...
    models = {
        ...
        u'accounts.usersid': {
            ...
            'expired_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 2, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'user_sid_set'", 'to': u"orm['accounts.User']"})
        },
        u'auth.group': {
