...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.tz'
        db.add_column(u'accounts_user', 'tz',
                      self.gf('django.db.models.fields.CharField')(default='UTC', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.tz'
        db.delete_column(u'accounts_user', 'tz')
    ...
    models = {
        u'accounts.user': {
            ...
            'tz': ('django.db.models.fields.CharField', [], {'default': "'UTC'", 'max_length': '64'}),
        ...
        u'accounts.usersid': {
            ...
            'expired_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 23, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
